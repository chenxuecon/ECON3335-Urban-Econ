...
.hi[.ul[Name:]] Chen Xu. Feel free to call me .h[Chen]

- Office: [TRUS 309](https://www.stedwards.edu/campus-map), Office Hours: .hi[TBD], Email: .hii[cxu@stedwards.edu]


--

.hi-blue[.ul[Area of Interests:]]

- .hi[Research]:
  - Applied micro topics related to labor economics
  - financial Economics, casual inference
  
- .hi[Teaching]:
  - Economics, Statistics, Data analysis
  
---
# Introduction: About me (cont.)

.hi-green[.ul[Not school:]]

  - Grew up in China
  - I like basketball `r emo::ji("basketball")`, recently fall in love with fishing `r emo::ji("fish")` `r emo::ji("call me hand")`
...
.hi[(ii)]  Have passed EC2301 with at least .hi-blue[some recollection] of the material
...
Attendance is ".hi[mandatory]". However,
- everyone has up to 3 absences
- your attendance grade will be .hi-red[deteriorated] after you miss more than 3 classes
- watch .hii[recorded] lectures to catch up
...
<!-- .hi[Slides] will be posted to the course page .smaller[(.l[https://ajdickinson/EC330F22])] _sometime_ after lecture<sup>.hii[†]</sup> -->
...
.hi[Your grade will be determined by:]

--

- .hi[5%]: Attendance 

- .hi[35%]: Problem sets (5 assingments)

- .hi[20%]: Midterm Exam

- .hi[20%]: Lab Quiz

- .hi[20%]: Final Group Project<sup>.hii[†]</sup>

.footnote[<sup>.hii[†]</sup> More details coming soon] 
--
...
- .hii[Unless] you have a valid excuse

- Must contact me **before** the exam with supporting documentation
...
.bigger[[Course site:](https://github.com/chenxuecon/ECON3335-Urban-Econ)]
